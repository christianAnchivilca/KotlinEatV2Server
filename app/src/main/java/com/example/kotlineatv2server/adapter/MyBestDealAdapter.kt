...
class MyBestDealAdapter (internal var context: Context,internal var listBestDeal:List<BestDealModel>):
    RecyclerView.Adapter<MyBestDealAdapter.MyViewHolder>(){
    ...
    override fun getItemCount(): Int {
        return listBestDeal.size
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        Glide.with(context).load(listBestDeal.get(position).image).into(holder.category_image!!)
        holder.category_name!!.setText(listBestDeal.get(position).name)
